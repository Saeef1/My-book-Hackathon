...
| :-------- | :------------------ | :---------------------------------------- |
| Sim Rig   | PC with RTX 4080    | Runs Isaac Sim, Gazebo, Unity, and trains |
|           | + Ubuntu 22.04      | LLM/VLA models.                           |
| Edge Brain| Jetson Orin Nano    | Runs the \"Inference\" stack. Students    |
|           |                     | deploy their code here.                   |
| Sensors   | RealSense Camera    | Connected to the Jetson to feed           |
|           | + Lidar             | real-world data to the AI.                |
| Actuator  | Unitree Go2 or G1   | Receives motor commands from the Jetson.  |
|           | (Shared)            |                                           |
...
| :------------ | :-------------------------- | :-------------- | :----------------------------------------------------------------- |
| The Brain     | NVIDIA Jetson Orin Nano     | $249            | New official MSRP (Price dropped from ~$499). Capable of 40 TOPS.  |
|               | Super Dev Kit (8GB)         |                 |                                                                    |
...
| Power/Misc    | SD Card (128GB)             | $30             | High-endurance microSD card required for the OS.                   |
|               | + Jumper Wires              |                 |                                                                    |
| **TOTAL**     |                             | **~$700 per kit**|                                                                    |
